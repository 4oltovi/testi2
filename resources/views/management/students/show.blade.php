    ...
    <div class="col-lg-8">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="8" class="text-center text-muted py-3">Баҳое мавҷуд нест.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
        ...
        <div class="card border-0 shadow-sm border-danger mb-3">
            <div class="card-header bg-danger bg-opacity-10">
                <h6 class="mb-0"><i class="bi bi-exclamation-triangle me-2"></i> Қарздориҳои фаъол ({{ $student->activeDebts->count() }})</h6>
            </div>
            <div class="card-body p-0">
