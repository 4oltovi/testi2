...
@section('page-description', 'Рӯйхати гурӯҳҳои ' . ($faculty?->name ?? 'факултет'))
        ...
        <div class="card-body py-3">
            <form method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <a href="{{ route('management.groups.index') }}" class="btn btn-outline-secondary"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($groups as $group)
                            <tr>
                                <td>
                                    <a href="{{ route('management.groups.show', $group) }}" class="fw-semibold text-decoration-none">
                                        {{ $group->name }}
                                    </a>
                                ...
                                <td>
                                    <span class="badge bg-primary">{{ $group->activeStudents->count() }}/{{ $group->max_students }}</span>
                                </td>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('management.groups.show', $group) }}" class="btn btn-sm btn-outline-info" title="Дидан">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
