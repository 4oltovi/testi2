...
@section('page-description', 'Рӯйхати омӯзгорони ' . ($faculty?->name ?? 'факултет'))
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body py-3">
            <form method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <input type="text" name="position" class="form-control" placeholder="Вазифа..."
                           value="{{ request('position') }}">
                </div>
                <div class="col-md-2">
                    <button type="submit" class="btn btn-outline-primary w-100"><i class="bi bi-search"></i></button>
                    <a href="{{ route('management.teachers.index') }}" class="btn btn-outline-secondary"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($teachers as $teacher)
                            <tr>
                                <td>
                                    <a href="{{ route('management.teachers.show', $teacher) }}" class="text-decoration-none fw-semibold">
                                ...
                                <td class="text-end">
                                    <a href="{{ route('management.teachers.show', $teacher) }}" class="btn btn-sm btn-outline-info"><i class="bi bi-eye"></i></a>
                                </td>
                            </tr>
                        @empty
