                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('management.journal.semester-grades', $assignment) }}"
                                    class="btn btn-outline-warning" title="Рейтинг/Имтиҳон">
                                    <i class="bi bi-trophy"></i> Рейтинг
                                </a>
                                <a href="{{ route('management.journal.attendance', $assignment) }}"
                                    class="btn btn-outline-info" title="Давомот">
                                    <i class="bi bi-check2-square"></i> Давомот
                                </a>
                            </div>
                        </td>
                    </tr>
