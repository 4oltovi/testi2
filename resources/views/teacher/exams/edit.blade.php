...
@section('title', 'Таҳрири тест')
@section('page-header', 'Таҳрири тест')
            ...
            <form method="POST" action="{{ route('teacher.exams.update', $exam) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="duration_minutes" class="form-control" value="{{ old('duration_minutes', $exam->duration_minutes) }}" min="1" max="300" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch mt-3">
                            <input class="form-check-input" type="checkbox" name="shuffle_questions" value="1"
                                   id="shuffle_q" {{ $exam->shuffle_questions ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch mt-3">
                            <input class="form-check-input" type="checkbox" name="shuffle_answers" value="1"
                                   id="shuffle_a" {{ $exam->shuffle_answers ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch mt-3">
                            <input class="form-check-input" type="checkbox" name="show_results_immediately" value="1"
                                   id="show_res" {{ $exam->show_results_immediately ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch mt-3">
                            <input class="form-check-input" type="checkbox" name="allow_back_navigation" value="1"
                                   id="back_nav" {{ $exam->allow_back_navigation ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="starts_at" class="form-control" value="{{ $exam->starts_at?->format('Y-m-d\TH:i') }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Анҷом</label>
                        <input type="datetime-local" name="ends_at" class="form-control" value="{{ $exam->ends_at?->format('Y-m-d\TH:i') }}">
                    </div>
                </div>

                <div class="text-end mt-4">
                    <a href="{{ route('teacher.exams.show', $exam) }}" class="btn btn-outline-secondary me-2">Бекор</a>
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-lg me-1"></i> Навсозӣ
                    </button>
                </div>
            </form>
        </div>
