...
@section('title', 'Илова ба нақшаи таълимӣ')
@section('page-header', 'Илова ба нақшаи таълимӣ')
@section('page-description', 'Илова кардани фан ба нақшаи таълимӣ')
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.structure.curriculum.store') }}">
                    @csrf
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('credits') is-invalid @enderror"
                                   id="credits" name="credits" value="{{ old('credits') }}" required min="1" max="30">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('total_hours') is-invalid @enderror"
                                   id="total_hours" name="total_hours" value="{{ old('total_hours') }}" required min="10" max="500">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('lecture_hours') is-invalid @enderror"
                                   id="lecture_hours" name="lecture_hours" value="{{ old('lecture_hours', 0) }}" min="0">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('practice_hours') is-invalid @enderror"
                                   id="practice_hours" name="practice_hours" value="{{ old('practice_hours', 0) }}" min="0">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('lab_hours') is-invalid @enderror"
                                   id="lab_hours" name="lab_hours" value="{{ old('lab_hours', 0) }}" min="0">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('independent_hours') is-invalid @enderror"
                                   id="independent_hours" name="independent_hours" value="{{ old('independent_hours', 0) }}" min="0">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('exam_type') is-invalid @enderror" id="exam_type" name="exam_type" required>
                                <option value="exam" {{ old('exam_type') == 'exam' ? 'selected' : '' }}>Имтиҳон</option>
                                <option value="credit" {{ old('exam_type') == 'credit' ? 'selected' : '' }}>Синҷиш</option>
                                <option value="diff_credit" {{ old('exam_type') == 'diff_credit' ? 'selected' : '' }}>Синҷиши бо баҳо</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('control_type') is-invalid @enderror" id="control_type" name="control_type" required>
                                <option value="rating_exam" {{ old('control_type') == 'rating_exam' ? 'selected' : '' }}>Рейтинг+Имтиҳон</option>
                                <option value="rating_only" {{ old('control_type') == 'rating_only' ? 'selected' : '' }}>Танҳо рейтинг</option>
                                <option value="project" {{ old('control_type') == 'project' ? 'selected' : '' }}>Лоиҳа</option>
                                <option value="coursework" {{ old('control_type') == 'coursework' ? 'selected' : '' }}>Курсавӣ</option>
                            </select>
                    ...
                    <div class="mb-4">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="is_elective" name="is_elective" value="1" {{ old('is_elective') ? 'checked' : '' }}>
