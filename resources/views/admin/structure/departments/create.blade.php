...
@section('title', 'Сохтани кафедраи нав')
@section('page-header', 'Сохтани кафедраи нав')
@section('page-description', 'Илова кардани кафедраи нав ба система')
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.structure.departments.store') }}">
                    @csrf
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('short_name') is-invalid @enderror"
                                   id="short_name" name="short_name" value="{{ old('short_name') }}" maxlength="20">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror"
                                   id="code" name="code" value="{{ old('code') }}" required maxlength="10" placeholder="мис: ANAT">
