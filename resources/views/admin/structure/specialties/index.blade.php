                        ...
                        @forelse($specialties as $spec)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <form action="{{ route('admin.structure.specialties.destroy', $spec) }}" method="POST" class="d-inline"
                                          onsubmit="return confirm('Оё мутмаин ҳастед? Ихтисос нест карда шавад.')">
                                        @csrf
                                        @method('DELETE')
