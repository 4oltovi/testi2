...
@section('title', 'Таҳрири ихтисос')
@section('page-header', 'Таҳрири ихтисос')
@section('page-description', 'Тағйир додани маълумоти ихтисос')
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.structure.specialties.update', $specialty) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror"
                                   id="code" name="code" value="{{ old('code', $specialty->code) }}" required maxlength="20" placeholder="мис: 1-79 01 01">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('education_level') is-invalid @enderror" id="education_level" name="education_level" required>
                                <option value="bachelor" {{ old('education_level', $specialty->education_level) == 'bachelor' ? 'selected' : '' }}>Бакалавр</option>
                                <option value="master" {{ old('education_level', $specialty->education_level) == 'master' ? 'selected' : '' }}>Магистр</option>
                                <option value="specialist" {{ old('education_level', $specialty->education_level) == 'specialist' ? 'selected' : '' }}>Мутахассис</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control @error('study_years') is-invalid @enderror"
                                   id="study_years" name="study_years" value="{{ old('study_years', $specialty->study_years) }}" required min="1" max="7">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control @error('total_credits') is-invalid @enderror"
                                   id="total_credits" name="total_credits" value="{{ old('total_credits', $specialty->total_credits) }}" required min="60" max="500">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('study_form') is-invalid @enderror" id="study_form" name="study_form" required>
                                <option value="full_time" {{ old('study_form', $specialty->study_form) == 'full_time' ? 'selected' : '' }}>Рӯзона</option>
                                <option value="part_time" {{ old('study_form', $specialty->study_form) == 'part_time' ? 'selected' : '' }}>Ғоибона</option>
                                <option value="evening" {{ old('study_form', $specialty->study_form) == 'evening' ? 'selected' : '' }}>Шабона</option>
                            </select>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $specialty->is_active) ? 'checked' : '' }}>
