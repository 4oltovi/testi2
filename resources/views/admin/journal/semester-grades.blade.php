...
@section('page-description')
    {{ $subjectAssignment->curriculum?->subject?->name }} | {{ $subjectAssignment->group?->name }} | {{ $semester->name }}
@endsection
        ...
        <div class="col-md-3">
            <div class="card border-0 bg-primary bg-opacity-10 h-100">
                <div class="card-body text-center">
                    <h3 class="text-primary mb-0">{{ $curriculum->credits }}</h3>
        ...
        <div class="col-md-6">
            <div class="card border-0 bg-light h-100">
                <div class="card-body">
                    ...
                    <strong>((Рейтинг + Журнал) / 2) + (Имтиҳон × 0,5)</strong>
                    ...
                    <tbody>
                        @foreach($students as $index => $student)
                            ...
                            <tr class="{{ $grade && $grade->is_finalized ? 'table-light' : '' }}">
                                ...
                                <td>
                                    @if($grade && !$grade->is_finalized && $grade->exam_score !== null)
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered mb-0">
                        <thead class="table-success">
                            <tr><th>Баҳо</th><th>GPA</th><th>%</th><th>Анъанавӣ</th></tr>
                        </thead>
                        <tbody>
                            <tr><td><span class="badge bg-success">A</span></td><td>4.00</td><td>95-100</td><td>Аъло</td></tr>
                            <tr><td><span class="badge bg-success">A-</span></td><td>3.67</td><td>90-94</td><td>Аъло</td></tr>
                            <tr><td><span class="badge bg-primary">B+</span></td><td>3.33</td><td>85-89</td><td>Хуб</td></tr>
                            <tr><td><span class="badge bg-primary">B</span></td><td>3.00</td><td>80-84</td><td>Хуб</td></tr>
                            <tr><td><span class="badge bg-primary">B-</span></td><td>2.67</td><td>75-79</td><td>Хуб</td></tr>
                            <tr><td><span class="badge bg-warning">C+</span></td><td>2.33</td><td>70-74</td><td>Қаноатбахш</td></tr>
                        </tbody>
                    </table>
                </div>
                <div class="col-md-6">
                    <table class="table table-sm table-bordered mb-0">
                        ...
                        <tbody>
                            <tr><td><span class="badge bg-warning">C</span></td><td>2.00</td><td>65-69</td><td>Қаноатбахш</td></tr>
                            <tr><td><span class="badge bg-warning">C-</span></td><td>1.67</td><td>60-64</td><td>Қаноатбахш</td></tr>
                            <tr><td><span class="badge bg-warning">D+</span></td><td>1.33</td><td>55-59</td><td>Қаноатбахш</td></tr>
                            <tr><td><span class="badge bg-warning">D</span></td><td>1.00</td><td>50-54</td><td>Қаноатбахш</td></tr>
                            <tr class="table-danger"><td><span class="badge bg-danger">Fx</span></td><td>0</td><td>45-49</td><td>Ғайриқ. (такрор.)</td></tr>
                            <tr class="table-dark"><td><span class="badge bg-dark">F</span></td><td>0</td><td>0-44</td><td>Ғайриқ. (дубора)</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
